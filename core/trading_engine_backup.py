            ...
            if result.retcode == mt5.TRADE_RETCODE_DONE:
                ...
                if stop_loss is not None or take_profit is not None:
                    ...
                    if positions:
                        ...
                        logger.debug("⚠️  WARNING: No position found to modify SL/TP")
                ...
                if positions:
                    ...
                    if stop_loss is not None:
                        ...
                        if sl_mismatch > 0.01:
                            logger.debug("🚨 CRITICAL BUG: MT5 ignored our SL!")
                    ...
                    logger.debug("⚠️  WARNING: No positions found after order placement!")
