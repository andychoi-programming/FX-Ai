...
print(f'   Status: [MATCHES] MATCHES (no conflict)')
...
print(f'   Status: [WITHIN LIMIT] WITHIN LIMIT')

print('\n'+'='*70)
print('RECOMMENDATIONS:')
print('='*70)
print('\n[REMOVE] REMOVE: minimum_sl_pips restriction (currently 25 pips)')
...
print('\n[KEEP] KEEP: risk_reward_ratio = 3.0 (but enforcement is 2.9:1)')
...
print('\n[KEEP] KEEP: close_hour = 22, close_minute = 30')
print('  Reason: Matches optimized parameters')
print('\n[KEEP] KEEP: maximum_sl_pips = 50 for forex')
